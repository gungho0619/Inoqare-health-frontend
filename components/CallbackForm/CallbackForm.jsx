...
const CallbackForm = ({title, user_type}) => {
	...
	return (
		<section className={`Login-wrap ${styles.wrapper}`} style={{ backgroundColor: "white" }}>
			<div className="login-form">
				<div className="login-header bg-minsk no-margin-padding">
					<h2 className="fs-20 fw-600 text-white fs-sm-20">{title}</h2>
				</div>
							...
							<div className="col-md-6">
								<div className="form-group broker-form-group">
									<input
										...
										type="text"
										className={`form-control broker-field ${errorMsg.organization_name && "error-input"}`}
							...
							<div className="col-md-6">
								<div className="form-group broker-form-group">
									<input
										...
										onChange={handleChange}
										type="text"
										className={`form-control broker-field ${
							...
							<div className="col-md-6">
								<div className="form-group broker-form-group">
									<input
										...
										onChange={handleChange}
										type="number"
										className={`form-control broker-field ${errorMsg.phone && "error-input"}`}
